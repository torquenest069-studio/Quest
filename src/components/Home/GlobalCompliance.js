  ...
  return (
    <>
      <SEO
        ...
        description="Navigate global pharmaceutical regulatory standards including US FDA 21 CFR, EU GMP, WHO, and ICH guidelines with Quest Pharma."
        keywords="US FDA compliance, EU GMP standard, WHO guidelines, ICH harmonization, pharma regulatory"
      ...
      <div>
        <section className="compliance-section">
          <div className="compliance-container">
            {/* Header Section */}
            <div className="compliance-header fade-in">
              <span className="section-subtitle">GLOBAL COMPLIANCE</span>
              <h1>Aligned with Global Regulatory Standards</h1>
