...
const About = () => {
  ...
  return (
    <>
      <SEO
        title="About Us"
        description="Learn about Quest Pharma Solutions, representing deep pharmaceutical quality expertise and an unwavering commitment to global GMP standards."
        keywords="About Quest Pharma, pharma quality solutions, GMP expertise, pharmaceutical leadership"
        canonical="/About"
      />
      <section className="about-section">
        <div className="container">
          <div className="about-header">
            ...
            <h1>A Legacy of Quality Leadership</h1>
            <p>
