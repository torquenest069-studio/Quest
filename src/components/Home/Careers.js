...
const Careers = () => {
  ...
  return (
    <>
      <SEO
        title="Careers"
        description="Join the team at Quest Pharma. We are looking for passionate pharmaceutical experts dedicated to regulatory excellence and manufacturing safety."
        keywords="Quest Pharma careers, pharma jobs, quality assurance careers, GMP jobs"
        canonical="/Careers"
      />
      <section className="careers-page">
        <div className="careers-hero">
          <div className="carcontainer">
            ...
            <h1>Shape the Future of Quality</h1>
              ...
              <div className="no-openings-card">
                <div className="no-openings-content">
                  ...
                  <div className="cv-cta-box">
                    ...
                    <a href="mailto:ravi@questpharmasolution.com" className="btn-primary-neon">
                      <FiSend /> Send Your CV
                    </a>
                  </div>
                </div>
