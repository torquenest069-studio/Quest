...
const Services = () => {
  ...
  return (
    <>
      <SEO
        title="Services"
        description="Comprehensive pharmaceutical quality and compliance solutions including GMP audits, CMO qualification, and regulatory inspection readiness."
        keywords="GMP compliance, pharmaceutical audits, CMO qualification, regulatory readiness, quality systems"
        canonical="/services"
      />
      <section className="services-section">
        <div className="services-container">
          <div className="services-header fade-in">
            ...
            <h1>Comprehensive Quality & Compliance Solutions</h1>
          ...
          <div className="engagement-card">
            ...
            <button
              ...
              onClick={() => router.push('/contact')} > Your Requirements</button>
          </div>
        </div>
      </section>
      <FAQ background="#fcfdfe" />
    </>
  );
};
