...
const Leadership = () => {
  return (
    <>
      <SEO
        title="Leadership"
        description="Meet Ravi B, Principal Consultant at Quest Pharma, a recognized authority in pharmaceutical quality assurance with 24+ years of global experience."
        keywords="Ravi B, pharmaceutical leadership, pharma consultant, quality assurance expert, GMP auditor"
        canonical="/leadership"
      />
      <section className="leadership-section">
        <div className="leadership-container">
          <div className="leadership-header fade-in">
